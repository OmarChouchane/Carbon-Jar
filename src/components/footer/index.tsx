...
const Footer = () => {
  return (
    <footer
      className={
        "bg-green lg:mx-32 sm:mx-1 md:mx-10 lg:mt-8 md:mt-10 px-8 sm:px-2 lg:px-10 lg:mb-10 rounded-lg lg:rounded-xl border border-border-white flex flex-col sm:flex-row justify-between items-start"
      }
    >
      <div className="flex flex-col lg:gap-4">
        ...
        <div
          className={
            "flex flex-col lg:gap-3 gap-2 lg:mb-8 mb-4 md:mt-6 lg:mx-8 lg:px-8"
          }
        >
          <div className="flex items-center lg:gap-3">
            <Location className="w-6 h-7" />
      ...
      <div
        className={
          "flex flex-col justify-end text-left mt-6 lg:mt-10 gap-3 lg:m-8"
        }
      >
        {[
          { name: "Home", href: "/" },
      ...
      <div
        className="hidden sm:flex mx-4 flex-col justify-end items-center mt-8"
      >
