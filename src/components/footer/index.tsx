...
const Footer = () => {
  return (
    <footer className={tw`bg-green lg:mx-32 sm:mx-1 md:mx-10 lg:mt-8 md:mt-10 px-8 sm:px-2 lg:px-10 lg:mb-10 rounded-lg lg:rounded-xl border border-border-white flex flex-col sm:flex-row justify-between items-start`}>
      <div className={tw`flex flex-col lg:gap-4`}>
        <div className={tw`flex items-center gap-3 lg:m-6 m-4`}>
          <a href="/">
          <img src="CarbonJar2.svg" alt="CarbonJar" className={tw`lg:w-80 w-60 h-10 lg:h-10`} />
          </a>
        </div>
        <div className={tw`flex flex-col lg:gap-3 gap-2 lg:mb-8 mb-4 md:mt-6 lg:mx-8 lg:px-8`}>
          ...
          <div className={tw`flex items-center lg:gap-3`}>
            ...
            <a href='https://carbonjar.tn/'><H2 className={tw`text-white-light`}>https://carbonjar.tn/</H2></a>
          </div>
        </div>
      </div>
      <div className={tw`flex flex-col justify-end text-left mt-6 lg:mt-10 gap-3 lg:m-8`}>
        {[
          { name: 'Home', href: '/' },
      ...
      <div className={tw`hidden sm:flex mx-4 flex-col justify-end items-center mt-8`}>
        <div className={tw`flex flex-col items-center gap-3`}>
          <H2 className={tw`text-center text-white-light`}>Find us on social media</H2>
          <div className={tw`flex gap-2`}>
            <Facebook className={tw`w-7 h-7`} />
            <a href="https://www.linkedin.com/company/carbon-jar/"><Linkedin className={tw`w-7 h-7`} /></a>
