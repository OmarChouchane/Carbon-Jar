...
const FAQSection: React.FC = () => {
  return (
    ...
    >
    <section className={tw('lg:mx-32 sm:mx-1 md:mx-10 lg:px-8 px-2 lg:mt-8 mb-12 ')}>
    <SmallerH1 className={tw('text-white-light')}>FAQs</SmallerH1>
    <H2 className={tw('text-white-light')}>Replying to the most frequently asked questions</H2>
    <br />
    <div className="space-y-4">
      {faqs.map((faq, index) => (
        <QuestionCard key={index} question={faq.question} answer={faq.answer} />
      ))}
    </div>
    </section>
    </motion.div>
