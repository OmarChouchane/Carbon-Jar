...
const BigCard1: React.FC<BigCardProps> = ({ title, image, description, Maindescription, button1, button2 }) => (
  <div
    className={tw('flex lg:m-8 m-4 flex-col lg:flex-row justify-start items-center lg:items-stretch gap-4 p-4 rounded-lg border border-lighter-green')}>
    <img
