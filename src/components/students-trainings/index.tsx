...
{/*
  NOTE: 
  I have added the courses to this page statically as per the current design requirements. The data is hardcoded in the `Courses` array within the `StudentsTrainings` component.

  TODO:
  - Fetch courses data from the backend database in the future.
  - Use an API endpoint to retrieve course data dynamically.
  - Update the `StudentsTrainings` component to handle asynchronous data fetching.
  ...
  const Courses:CourseCard[] = [
    {
      ...
      duration: 5,
      certified: true,
      overview: "Life Cycle Assessment (LCA) quantifies the environmental impacts of a product, process, or service over its entire life cycle. From resource extraction to production, usage, and disposal, every stage can significantly influence the environment. LCA helps you assess these impacts comprehensively.",
      trainingTitle: "Life Cycle Assessment 101",
      trainingDescription: "Welcome to Carbon Jar’s LCA 101! Looking to learn about Life Cycle Assessment (LCA), understand its relevance to your studies and career, or improve communication with LCA experts? Our online course offers all this and more, tailored especially for university students and young professionals.",
      whyCourse:  [
    ...
    },
    {
      ...
      overview: "Understanding and managing your carbon footprint is essential for identifying inefficiencies in energy and resource use. Knowing the total greenhouse gas (GHG) emissions and their sources is crucial for making informed decisions and contributing to sustainability efforts.",
      trainingDescription2: "This training is designed for university students and young professionals who want to learn how to assess and manage carbon footprints. You’ll gain practical knowledge and techniques through real-life case studies, helping you make a positive impact in your field.",
      content2: new Map([
...
return (
  ...
  >
    <section className={tw('flex flex-col bg-green lg:p-12 lg::pb-20  lg:pt-20 p-6 lg:mt-8 mt-6 lg:mt-40')}>
