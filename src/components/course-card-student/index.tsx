...
const CourseCardStudent: React.FC<CourseCardStudentProps> = ({
  ...
  return (
    <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}>
      <div
        className="relative items-start m-8 lg:px-8 gap-4 rounded-lg border border-green-dark bg-green-dark shadow-md p-6"
      >
        <motion.a
          href={link}
        ...
        <div className="flex flex-wrap gap-4 mb-4">
          ...
          {certified && (
            <SmallerBox
              text={
                <>
                  <FaCheck className="inline mr-1 text-green-light" />{" "}
                  Certified
                </>
              }
            />
        ...
        <div className="flex flex-col items-start gap-4">
          ...
          <div className="mt-2">
            ...
            {content1 && (
              <ul
                className="list-disc pl-5 mt-2 text-white-light items-left text-left font-Inter"
              >
          ...
          {certified && (
            <div className="mt-2">
              <H2 className="text-white-light text-left">
                <span className="text-white-light font-bold text-left">
                  Certification:{" "}
                </span>
