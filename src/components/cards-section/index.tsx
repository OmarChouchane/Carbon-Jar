...
const CardsSection: React.FC = () => {
  const card1 = {
    ...
    description: "Join the growing movement towards a sustainable future. At CarbonJar, we empower organizations to understand, manage, and reduce their carbon footprints, promoting sustainable practices and innovations.",
    button1: "Learn More",
  ...
  const card2 = {
    ...
    description: (
      <>
        Our courses are <span className="font-bold text-left">100% online</span>, making them accessible to learners around the globe. We are proud to offer our content in three languages, ensuring that language is not a barrier to climate education.<br />  Most importantly, our training is effective. A whopping <span className="font-bold">87% of our participants report feeling better equipped</span> to take action in their organizations in the face of climate change.
      </>
    ),
    button1: "Learn More",
