...
const BigCard2: React.FC<BigCardProps> = ({ title, description, Maindescription, icon, button1, description1 }) => (
  <div
    className={tw('flex lg:mt-12 flex-col bg-light-green mx-auto lg:flex-row justify-start items-left lg:items-stretch lg:p-8 p-2 rounded-lg border border-lighter-green')}
  >
    <div className={tw('flex flex-col justify-start items-left gap-6 lg:ml-6')}>
      <div className={tw('flex flex-col justify-start items-left')}>
        ...
        <H2 className={tw('lg:mx-6  mx-2 justify-start text-left')}>{description}</H2>
      </div>
      {button1 && (
